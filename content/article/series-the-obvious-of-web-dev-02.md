...
前節までは「Web開発技術」という言葉が示す領域の **「広さ」** と **「誰が知るべきか」** を示したが、 **「深さ」** についても見ていこう。具体的には、どこからどこまでの時点のモデルまでを現代の前提知識、つまり、ある組織や集団に限らない世間一般の規範的モデルおよび共通マインドモデルと考えるかという **「いつにおける」** **「誰にとって」** の観点だ。
...
ここから言えることは一つ、 **「単に今のモダンと言われるモデルを学んだだけでは、システムに関わるすべての人の業務や作業の前提知識が揃ったとは言えない可能性がある」** ということになる。では、どこを対象にしてあたりまえと考えるのだろうか。

この点はかなりの争論を呼ぶところではあるが、ひとまず、僕の定義に従ってもらいたい。  
**ここでは、2015年から2018年ごろに日本にあったWebのトレンドと、そのトレンドを支える基盤技術のことを世間的なWeb開発技術の「あたりまえ」の時期として定義する。** 海外にも同じようなモダンの基準はあるかもしれないが、詳細な時期は把握できていないが、概ね米国の1～2年遅れとして認識している。

理由を話す前に、まず僕が2023年における「モダン」として認識しているものを提示しておこう。  
...
しばしば言われるのが、「DevOpsは抽象クラスのようなもので、SREはDevOpsを実行するためのGoogle製の実装」というものだ。

[^8]: DevOpsについて一言で表すのは難しい。考え方やツールやプラクティスがあまりにも多すぎるので、今回はこの分野には詳しく触れない。詳細は各自で調べてほしい。DevOpsに関わる本は多くあるが、特に開発者が理解を進める際に有用な本として、本文にあげた『サイトリライアビリティエンジニアリング ―Googleの信頼性を支えるエンジニアリングチーム』だけでなく、[『LeanとDevOpsの科学 テクノロジーの戦略的活用が組織変革を加速する』](https://www.amazon.co.jp/dp/4295004901)を特に推奨する。
